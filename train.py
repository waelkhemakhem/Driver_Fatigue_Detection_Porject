...
def Create_train_test_val_loader(
    ...
    X_train, X_test, X_val, y_train, y_test, y_val = split_train_val_test(images, labels, train=0.6, test=0.2, val=0.2)
...
def train(
    ...
    model.classifier = nn.Sequential(
        ...
        nn.ReLU(inplace=True),
        nn.Dropout(p=0.5, inplace=False),
        nn.Linear(in_features=4096, out_features=136, bias=True),
    )
